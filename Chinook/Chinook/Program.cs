...
builder.Services.AddScoped<INavMenuDataService, NavMenuDataService>();
builder.Services.AddScoped<IArtistPageDataService, ArtistPageDataService>();
builder.Services.AddScoped<IIndexPageDataService, IndexPageDataService>();
builder.Services.AddScoped<IPlaylistPageDataService, PlaylistPageDataService>();
